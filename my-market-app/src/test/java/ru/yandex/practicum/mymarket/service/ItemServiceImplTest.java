...
class ItemServiceImplTest {
    ...
    @Test
    void getItemDtosByIds_ShouldReturnAllItems() {
        Set<Long> ids = Set.of(
        ...
        List<ItemDto> result = itemService.getItemDtosByIds(ids)
                .collectList()
                .block();
    ...
    @Test
    void getItemDtosByIds_WithEmptySet_ShouldReturnEmptyFlux() {
        StepVerifier.create(itemService.getItemDtosByIds(Set.of()))
                .verifyComplete();
    }
}